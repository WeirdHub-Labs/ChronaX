...
public class NodeEvaluatorCache {
    ...
    private static final Map<NodeEvaluator, NodeEvaluatorFeatures> nodeEvaluatorToFeatures = new ConcurrentHashMap<>();
    ...
    public static @NotNull NodeEvaluator takeNodeEvaluator(@NotNull NodeEvaluatorGenerator generator, @NotNull NodeEvaluator localNodeEvaluator) {
        ...
        nodeEvaluatorToFeatures.putIfAbsent(nodeEvaluator, nodeEvaluatorFeatures);
    ...
    public static void returnNodeEvaluator(@NotNull NodeEvaluator nodeEvaluator) {
        ...
        if (generator == null) {
            throw new IllegalStateException("NodeEvaluator already returned");
        }

        NodeEvaluatorFeatures nodeEvaluatorFeatures = nodeEvaluatorToFeatures.get(nodeEvaluator);
        if (nodeEvaluatorFeatures == null) {
            nodeEvaluatorFeatures = NodeEvaluatorFeatures.fromNodeEvaluator(nodeEvaluator);
            nodeEvaluatorToFeatures.put(nodeEvaluator, nodeEvaluatorFeatures);
        }
    ...
    public static void removeNodeEvaluator(@NotNull NodeEvaluator nodeEvaluator) {
        ...
        nodeEvaluatorToFeatures.remove(nodeEvaluator);
    }
}
