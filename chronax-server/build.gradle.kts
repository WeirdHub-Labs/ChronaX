...
paperweight {
    ...
    val chronax = forks.register("chronax") {
        upstream.patchDir("paperServer") {
            upstreamPath = "paper-server"
            excludes = setOf("src/minecraft", "patches", "build.gradle.kts")
            patchesDir = rootDirectory.dir("chronax-server/paper-patches")
...
dependencies {
    implementation(project(":chronax-api")) // ChronaX - project setup
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "ChronaX", // ChronaX - Rebrand
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "ChronaX", // ChronaX - Rebrand
            "Specification-Version" to project.version,
            "Specification-Vendor" to "wrd", // ChronaX - Rebrand
            "Brand-Id" to "wrd:chronax", // ChronaX - Rebrand
            "Brand-Name" to "ChronaX", // ChronaX - Rebrand
